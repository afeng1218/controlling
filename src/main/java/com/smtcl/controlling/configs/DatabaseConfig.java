...
/**
 * [Product] controlling [Copyright] Copyright © 2016 ICSS All Rights Reserved. [FileName] DatabaseConfig.java [History] Version Date Author Content
 * -------- --------- ---------- ------------------------ v1.0.0 2016年1月8日 longpeng 最初版本
 * <p>
 * changed by guofeng v1.0.1 2016年7月13日
 **/

package com.smtcl.controlling.configs;
